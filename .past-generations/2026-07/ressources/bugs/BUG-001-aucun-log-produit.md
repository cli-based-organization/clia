...
type: bug
version: 0.1.0
title: "Aucun log produit pour les tâches de production de plan"
status: résolu
---
...
- **Tâche liée** : tâche 12 (production de PLN-005) ; log correctif : `.dev/logs/ia-output/LOG-2026-07-09-task-13.md`

## Rapport

**Attendu** : toute tâche exécutée par l'agent produit un log dans `.dev/logs/ia-output/<DATE>_task-<NN>.md`.
...
1. **`CLAUDE.md`** : ajout d'une section « Journalisation obligatoire » énonçant sans ambiguïté que toute tâche traitée, y compris la seule production ou révision d'un plan, se termine par un log dans `.dev/logs/ia-output/`, sans exception. Enregistrement du type BUG et de `skl-013` dans la table des livrables et la nomenclature.
...
Fichiers modifiés ou créés : `CLAUDE.md`, `CONSTITUTION.md`, `.dev/skills/skl-008-log-ia-output/SKILL.md`, `.dev/adr/ADR-003-gestion-des-bogues.md`, `.dev/skills/skl-013-rapport-de-bogue/SKILL.md`, `.dev/bugs/BUG-001-aucun-log-produit.md`, `.dev/logs/ia-output/LOG-2026-07-09-task-09.md`, `LOG-2026-07-09-task-10.md`, `LOG-2026-07-09-task-12.md`, `LOG-2026-07-09-task-13.md`.

## Vérification

- Les logs `task-09`, `task-10`, `task-12` existent désormais dans `.dev/logs/ia-output/`.
