# FND-2026-07-18 - Architecture des systèmes complexes : méthodes, visualisation, artefacts et pratiques
...
**Bonnes pratiques** :
- **Intégrité conceptuelle** (Brooks) : une vision unificatrice cohérente prime (voir `FND-2026-07-18-principes-de-conception-systemes-complexes`).
...
- `FND-2026-07-18-documents-harness-ia` (méthodologies et harnais IA, ce dépôt) ; `FND-2026-07-18-principes-de-conception-systemes-complexes` (Simon, Brooks).
