# ANL-2026-07-21 - Usages de la sémantique et de l'ontologie dans le corpus de dépôts, et positionnement de clia
...
- **Référence** : `FND-2026-07-21-ontologie-et-semantique` (définitions, spectre, distinctions taxonomie/ontologie/graphe, formes légères, ancrage des agents). Complément : `FND-2026-07-18-llm-wiki-okf-gestion-connaissance` et `ANL-2026-07-18-clia-et-open-knowledge-format`.
...
3. **Le typage des instances n'est pas uniforme ni machine-vérifiable.** Seuls les fichiers de session portent un frontmatter. Les autres ressources ne déclarent pas leur `type` en métadonnée : leur classe se déduit du préfixe de nom et du répertoire. C'est exactement l'écart déjà relevé par `ANL-2026-07-18-clia-et-open-knowledge-format` face à l'OKF, et l'objet de la tâche 24 (« Adoption des conventions clefs de l'OKF »).
