...
- **Origine** : session.md tâche 21 (généré depuis `ANL-2026-07-18-principes-de-conception-du-repo`, P2)
...
Contexte : constaté par `ANL-2026-07-18-usage-ia-projet` (C3) puis formalisé comme écart à `PDC-002`.
