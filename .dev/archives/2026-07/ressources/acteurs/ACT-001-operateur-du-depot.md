...
Ce est pas celui qui équipe un dépôt ([`ACT-003`](ACT-003-installateur.md)), ni celui qui fait évoluer le système d'augmentation lui-même ([`ACT-004`](ACT-004-mainteneur-du-systeme-augmentation.md)). Une même personne tient couramment les trois rôles ; leurs buts, leurs préconditions et leurs modes d'échec diffèrent.
