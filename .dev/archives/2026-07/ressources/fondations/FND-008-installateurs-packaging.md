...
Périmètre : modèles et outils indépendants d'un projet donné. Hors périmètre : la convention d'interface CLI (voir `FND-007-conventions-cli`), et les détails d'empaquetage propres à un langage au-delà de leur principe.
