...
type: analyse
version: 0.1.0
title: "Analyse critique de CONSTITUTION.md : gouvernance vs orchestration"
date: 2026-07-18
---

# ANL-008 - Analyse critique de CONSTITUTION.md : gouvernance vs orchestration
...
- **Référence** : `FND-011-documents-harness-ia` (distinction gouvernance / orchestration de processus, séparation des préoccupations).
...
Face à la `FND-011-documents-harness-ia` :
